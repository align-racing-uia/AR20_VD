...
#include "dempsystest_bjorn_59d2bdba_1_gateway.h"

void dempsystest_bjorn_59d2bdba_1_gateway(void)
{
  ...
  dempsystest_bjorn_59d2bdba_1_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group("dempsystest_bjorn/Solver Configuration_1",
    1,
    &dae,
    &solverparams,
    &modelparams,
