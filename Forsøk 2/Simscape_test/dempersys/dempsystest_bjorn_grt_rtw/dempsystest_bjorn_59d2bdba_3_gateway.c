...
#include "nesl_rtw.h"
#include "dempsystest_bjorn_59d2bdba_3.h"
#include "dempsystest_bjorn_59d2bdba_3_gateway.h"

void dempsystest_bjorn_59d2bdba_3_gateway(void)
{
  ...
  dempsystest_bjorn_59d2bdba_3_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group("dempsystest_bjorn/Solver Configuration_3",
    1,
    &dae,
    &solverparams,
    &modelparams,
