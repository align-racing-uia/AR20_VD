 ...
 */
/* dempsystest_bjorn_59d2bdba_4_ds.c - body for module dempsystest_bjorn_59d2bdba_4_ds */

#include "ne_ds.h"
#include "dempsystest_bjorn_59d2bdba_4_ds.h"
#include "ssc_ml_fun.h"
#include "dempsystest_bjorn_59d2bdba_4_ds_external_struct.h"
#include "dempsystest_bjorn_59d2bdba_4_ds_sys_struct.h"
#include "dempsystest_bjorn_59d2bdba_4_ds_externals.h"
...
static NeEquationData s_equation_data[2] = { { "", 0U, 8,
    NE_EQUATION_DOMAIN_TIME, "dempsystest_bjorn/Subsystem/Wheel Rest/Hard Stop",
    2U, 0U, TRUE, 1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "dempsystest_bjorn/Subsystem/Wheel Rest/Hard Stop", 5U, 2U, TRUE, 1.0, "1",
  } };

static NeICRData *s_icr_data = NULL;
static NeVariableData s_variable_data[2] = { {
    "Subsystem.Wheel_Rest.Hard_Stop.x", 0U, 0,
    "dempsystest_bjorn/Subsystem/Wheel Rest/Hard Stop", 1.0, "1", 0.0, TRUE,
    FALSE, 1U, 1U, NE_INIT_MODE_MANDATORY, "Position", }, {
    "Subsystem.Wheel_Rest.Hard_Stop.f", 0U, 0,
    "dempsystest_bjorn/Subsystem/Wheel Rest/Hard Stop", 1.0, "1", 0.0, FALSE,
...
static NeObservableData s_observable_data[17] = { {
    "Subsystem.Wheel_Rest.Hard_Stop.C.v",
    "dempsystest_bjorn/Subsystem/Wheel Rest/Hard Stop", 1U, 1U, "m/s", 1.0,
    "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Subsystem.Wheel_Rest.Hard_Stop.R.v",
    "dempsystest_bjorn/Subsystem/Wheel Rest/Hard Stop", 1U, 1U, "m/s", 1.0,
    "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Subsystem.Wheel_Rest.Hard_Stop.f",
    "dempsystest_bjorn/Subsystem/Wheel Rest/Hard Stop", 1U, 1U, "N", 1.0, "N",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Force", }, {
    "Subsystem.Wheel_Rest.Hard_Stop.v",
    "dempsystest_bjorn/Subsystem/Wheel Rest/Hard Stop", 1U, 1U, "m/s", 1.0,
    "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Subsystem.Wheel_Rest.Hard_Stop.x",
    "dempsystest_bjorn/Subsystem/Wheel Rest/Hard Stop", 1U, 1U, "cm", 1.0, "m",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_MANDATORY, FALSE, TRUE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Position", }, {
    "Subsystem.Wheel_Rest.Prismatic_Translational_Interface.C.v",
    "dempsystest_bjorn/Subsystem/Wheel Rest/Prismatic-Translational Interface",
    1U, 1U, "m/s", 1.0, "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    TRUE, FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Velocity", }, {
    "Subsystem.Wheel_Rest.Prismatic_Translational_Interface.Force_Sensor.C.v",
    "dempsystest_bjorn/Subsystem/Wheel Rest/Prismatic-Translational Interface/Force Sensor",
    1U, 1U, "m/s", 1.0, "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Subsystem.Wheel_Rest.Prismatic_Translational_Interface.Force_Sensor.F",
    "dempsystest_bjorn/Subsystem/Wheel Rest/Prismatic-Translational Interface/Force Sensor",
    1U, 1U, "N", 1.0, "N", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "F", }, {
    "Subsystem.Wheel_Rest.Prismatic_Translational_Interface.Force_Sensor.R.v",
    "dempsystest_bjorn/Subsystem/Wheel Rest/Prismatic-Translational Interface/Force Sensor",
    1U, 1U, "m/s", 1.0, "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Subsystem.Wheel_Rest.Prismatic_Translational_Interface.Force_Sensor.f",
    ...
    "Subsystem.Wheel_Rest.Prismatic_Translational_Interface.R.v",
    "dempsystest_bjorn/Subsystem/Wheel Rest/Prismatic-Translational Interface",
    1U, 1U, "m/s", 1.0, "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Velocity", }, {
    "Subsystem.Wheel_Rest.Prismatic_Translational_Interface.Velocity_Source.C.v",
    "dempsystest_bjorn/Subsystem/Wheel Rest/Prismatic-Translational Interface/Velocity Source",
    1U, 1U, "m/s", 1.0, "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    TRUE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Subsystem.Wheel_Rest.Prismatic_Translational_Interface.Velocity_Source.R.v",
    "dempsystest_bjorn/Subsystem/Wheel Rest/Prismatic-Translational Interface/Velocity Source",
    1U, 1U, "m/s", 1.0, "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Subsystem.Wheel_Rest.Prismatic_Translational_Interface.Velocity_Source.S",
    "dempsystest_bjorn/Subsystem/Wheel Rest/Prismatic-Translational Interface/Velocity Source",
    1U, 1U, "m/s", 1.0, "m/s", NE_NOMINAL_SOURCE_FIXED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "S", }, {
    "Subsystem.Wheel_Rest.Prismatic_Translational_Interface.Velocity_Source.f",
    "dempsystest_bjorn/Subsystem/Wheel Rest/Prismatic-Translational Interface/Velocity Source",
    1U, 1U, "N", 1.0, "N", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Force", }, {
    "Subsystem.Wheel_Rest.Prismatic_Translational_Interface.Velocity_Source.v",
    "dempsystest_bjorn/Subsystem/Wheel Rest/Prismatic-Translational Interface/Velocity Source",
    1U, 1U, "m/s", 1.0, "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Subsystem.Wheel_Rest.Reference.V.v",
    "dempsystest_bjorn/Subsystem/Wheel Rest/Reference", 1U, 1U, "m/s", 1.0,
    "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", } };

static NeModeData *s_major_mode_data = NULL;
static NeZCData s_zc_data[2] = { {
    "dempsystest_bjorn/Subsystem/Wheel Rest/Hard Stop", 1U, 0U,
    "Subsystem.Wheel_Rest.Hard_Stop",
    "C:/Program Files/MATLAB/R2020b/toolbox/physmod/simscape/library/m/+foundation/+mechanical/+translational/hardstop.ssc",
    NE_ZC_TYPE_TRUE, }, { "dempsystest_bjorn/Subsystem/Wheel Rest/Hard Stop", 1U,
    1U, "Subsystem.Wheel_Rest.Hard_Stop",
    "C:/Program Files/MATLAB/R2020b/toolbox/physmod/simscape/library/m/+foundation/+mechanical/+translational/hardstop.ssc",
    NE_ZC_TYPE_FALSE, } };
...
NeDynamicSystem *dempsystest_bjorn_59d2bdba_4_dae_ds(PmAllocator *allocator)
{
  NeDynamicSystem *ds;
  _NeDynamicSystem *_ds;
