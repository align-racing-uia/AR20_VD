 ...
 */
/* dempsystest_bjorn_59d2bdba_1_ds.c - body for module dempsystest_bjorn_59d2bdba_1_ds */

#include "ne_ds.h"
#include "dempsystest_bjorn_59d2bdba_1_ds.h"
#include "ssc_ml_fun.h"
#include "dempsystest_bjorn_59d2bdba_1_ds_external_struct.h"
#include "dempsystest_bjorn_59d2bdba_1_ds_sys_struct.h"
#include "dempsystest_bjorn_59d2bdba_1_ds_externals.h"
...
static NeEquationData s_equation_data[2] = { { "", 0U, 8,
    NE_EQUATION_DOMAIN_TIME, "dempsystest_bjorn/Wheel Rest4/Hard Stop1", 2U, 0U,
    TRUE, 1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "dempsystest_bjorn/Wheel Rest4/Hard Stop1", 5U, 2U, TRUE, 1.0, "1", } };

static NeICRData *s_icr_data = NULL;
static NeVariableData s_variable_data[2] = { { "Wheel_Rest4.Hard_Stop1.x", 0U, 0,
    "dempsystest_bjorn/Wheel Rest4/Hard Stop1", 1.0, "1", 0.0, TRUE, FALSE, 1U,
    1U, NE_INIT_MODE_MANDATORY, "Position", }, { "Wheel_Rest4.Hard_Stop1.f", 0U,
    0, "dempsystest_bjorn/Wheel Rest4/Hard Stop1", 1.0, "1", 0.0, FALSE, FALSE,
    1U, 1U, NE_INIT_MODE_NONE, "Force", } };

static NeVariableData *s_discrete_data = NULL;
static NeObservableData s_observable_data[17] = { { "Wheel_Rest4.Hard_Stop1.C.v",
    "dempsystest_bjorn/Wheel Rest4/Hard Stop1", 1U, 1U, "m/s", 1.0, "m/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Wheel_Rest4.Hard_Stop1.R.v", "dempsystest_bjorn/Wheel Rest4/Hard Stop1", 1U,
    1U, "m/s", 1.0, "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Wheel_Rest4.Hard_Stop1.f", "dempsystest_bjorn/Wheel Rest4/Hard Stop1", 1U,
    1U, "N", 1.0, "N", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Force", }, { "Wheel_Rest4.Hard_Stop1.v",
    "dempsystest_bjorn/Wheel Rest4/Hard Stop1", 1U, 1U, "m/s", 1.0, "m/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Wheel_Rest4.Hard_Stop1.x", "dempsystest_bjorn/Wheel Rest4/Hard Stop1", 1U,
    1U, "cm", 1.0, "m", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_MANDATORY, FALSE,
    TRUE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Position", }, {
    "Wheel_Rest4.Prismatic_Translational_Interface1.C.v",
    "dempsystest_bjorn/Wheel Rest4/Prismatic-Translational Interface1", 1U, 1U,
    "m/s", 1.0, "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Velocity", }, {
    "Wheel_Rest4.Prismatic_Translational_Interface1.Force_Sensor.C.v",
    "dempsystest_bjorn/Wheel Rest4/Prismatic-Translational Interface1/Force Sensor",
    1U, 1U, "m/s", 1.0, "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Wheel_Rest4.Prismatic_Translational_Interface1.Force_Sensor.F",
    "dempsystest_bjorn/Wheel Rest4/Prismatic-Translational Interface1/Force Sensor",
    1U, 1U, "N", 1.0, "N", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "F", }, {
    "Wheel_Rest4.Prismatic_Translational_Interface1.Force_Sensor.R.v",
    "dempsystest_bjorn/Wheel Rest4/Prismatic-Translational Interface1/Force Sensor",
    1U, 1U, "m/s", 1.0, "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Wheel_Rest4.Prismatic_Translational_Interface1.Force_Sensor.f",
    ...
    "Wheel_Rest4.Prismatic_Translational_Interface1.R.v",
    "dempsystest_bjorn/Wheel Rest4/Prismatic-Translational Interface1", 1U, 1U,
    "m/s", 1.0, "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Velocity", }, {
    "Wheel_Rest4.Prismatic_Translational_Interface1.Velocity_Source.C.v",
    "dempsystest_bjorn/Wheel Rest4/Prismatic-Translational Interface1/Velocity Source",
    1U, 1U, "m/s", 1.0, "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    TRUE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Wheel_Rest4.Prismatic_Translational_Interface1.Velocity_Source.R.v",
    "dempsystest_bjorn/Wheel Rest4/Prismatic-Translational Interface1/Velocity Source",
    1U, 1U, "m/s", 1.0, "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Wheel_Rest4.Prismatic_Translational_Interface1.Velocity_Source.S",
    "dempsystest_bjorn/Wheel Rest4/Prismatic-Translational Interface1/Velocity Source",
    1U, 1U, "m/s", 1.0, "m/s", NE_NOMINAL_SOURCE_FIXED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "S", }, {
    "Wheel_Rest4.Prismatic_Translational_Interface1.Velocity_Source.f",
    "dempsystest_bjorn/Wheel Rest4/Prismatic-Translational Interface1/Velocity Source",
    1U, 1U, "N", 1.0, "N", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Force", }, {
    "Wheel_Rest4.Prismatic_Translational_Interface1.Velocity_Source.v",
    "dempsystest_bjorn/Wheel Rest4/Prismatic-Translational Interface1/Velocity Source",
    1U, 1U, "m/s", 1.0, "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Wheel_Rest4.Reference1.V.v", "dempsystest_bjorn/Wheel Rest4/Reference1", 1U,
    1U, "m/s", 1.0, "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", } };

static NeModeData *s_major_mode_data = NULL;
static NeZCData s_zc_data[2] = { { "dempsystest_bjorn/Wheel Rest4/Hard Stop1",
    1U, 0U, "Wheel_Rest4.Hard_Stop1",
    "C:/Program Files/MATLAB/R2020b/toolbox/physmod/simscape/library/m/+foundation/+mechanical/+translational/hardstop.ssc",
    NE_ZC_TYPE_TRUE, }, { "dempsystest_bjorn/Wheel Rest4/Hard Stop1", 1U, 1U,
    "Wheel_Rest4.Hard_Stop1",
    "C:/Program Files/MATLAB/R2020b/toolbox/physmod/simscape/library/m/+foundation/+mechanical/+translational/hardstop.ssc",
    NE_ZC_TYPE_FALSE, } };
...
NeDynamicSystem *dempsystest_bjorn_59d2bdba_1_dae_ds(PmAllocator *allocator)
{
  NeDynamicSystem *ds;
  _NeDynamicSystem *_ds;
