...
#include "nesl_rtw.h"
#include "dempsystest_bjorn_59d2bdba_2.h"
#include "dempsystest_bjorn_59d2bdba_2_gateway.h"

void dempsystest_bjorn_59d2bdba_2_gateway(void)
{
  ...
  dempsystest_bjorn_59d2bdba_2_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group("dempsystest_bjorn/Solver Configuration_2",
    1,
    &dae,
    &solverparams,
    &modelparams,
