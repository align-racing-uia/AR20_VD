...
#include "nesl_rtw.h"
#include "dempsystest_bjorn_59d2bdba_5.h"
#include "dempsystest_bjorn_59d2bdba_5_gateway.h"

void dempsystest_bjorn_59d2bdba_5_gateway(void)
{
  NeModelParameters modelparams = { (NeSolverType) 0, 0.001, 0, 0, 0.001, 0, 0,
    0, 0, (SscLoggingSetting) 0, 544977863, };
  ...
  dempsystest_bjorn_59d2bdba_5_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group("dempsystest_bjorn/Solver Configuration_5",
    1,
    &dae,
    &solverparams,
    &modelparams,
