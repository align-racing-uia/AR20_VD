...
#include "nesl_rtw.h"
#include "dempsystest_bjorn_59d2bdba_4.h"
#include "dempsystest_bjorn_59d2bdba_4_gateway.h"

void dempsystest_bjorn_59d2bdba_4_gateway(void)
{
  NeModelParameters modelparams = { (NeSolverType) 0, 0.001, 0, 0, 0.001, 0, 0,
    0, 0, (SscLoggingSetting) 0, 544977803, };
  ...
  dempsystest_bjorn_59d2bdba_4_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group("dempsystest_bjorn/Solver Configuration_4",
    1,
    &dae,
    &solverparams,
    &modelparams,
